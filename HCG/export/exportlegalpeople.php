...
<html>
<head>
  <title>Export Data Legal People</title>
...
<body>
<div class="container">
			<h2 class="text-center mt-4">Data Legal People</h2>
            <a href="../legal_people.php" class="btn btn-danger float-right mb-3"><i class="fas fa-arrow-left"></i></a>
				<div class="data-tables datatable-dark">
					
                <table class="table table-bordered" id="legal_people" width="100%" cellspacing="0" style="text-transform: uppercase; margin-left: -20px;">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                                <th>NAMA LENGKAP</th>
                                                ...
                                                <th>INSTANSI YANG MENGELOARKAN</th>
                                                <th>TANGGAL MENGELOARKAN</th>
                                                <th>MASA HABIS</th>
                                                <th>KETERANGAN</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td><?= htmlspecialchars(TanggalIndo($row['tanggal_mengeluarkan'])) ?></td>
                                                <?php
                                                    if ($masa_habis !== 'Tidak Ada') {
                                                ?>
                                                    <td><?= htmlspecialchars(TanggalIndo($row['masa_habis'])) ?></td>
                                                <?php
                                                } else {
                                                ?>
                                                    <td><?= htmlspecialchars($row['masa_habis']) ?></td>
                                                <?php
                                                }
                                                ?>
