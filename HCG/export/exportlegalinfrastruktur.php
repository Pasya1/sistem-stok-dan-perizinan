...
<html>
<head>
  <title>Export Data Legal Infrastruktur</title>
...
<body>
<div class="container">
			<h2 class="text-center mt-4">Data Legal Infrastruktur</h2>
            <a href="../legal_infrastruktur.php" class="btn btn-danger float-right mb-3"><i class="fas fa-arrow-left"></i></a>
				<div class="data-tables datatable-dark">
					
                <table class="table table-bordered text-center" id="legalinfrastruktur" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
