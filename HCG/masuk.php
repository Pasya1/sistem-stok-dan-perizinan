                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Barang Masuk</h1>
                                    ...
                                    <button type="button" class="btn btn-custom shadow mb-3" data-toggle="modal" data-target="#myModal" style="float: right;">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata = mysqli_query($conn_hcg, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang WHERE m.tanggal_penerimaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata = mysqli_query($conn_hcg, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang WHERE m.tanggal_penerimaan = '$mulai'");
                                            } else {
                                                $ambilsemuadata = mysqli_query($conn_hcg, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang");
                                            }
                                        } else {
                                            $ambilsemuadata = mysqli_query($conn_hcg, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang");
                                        }
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <select name="supplier2" class="form-control" required>
                                                                    ...
                                                                    $ambilsemuadatasupplier = mysqli_query($conn_hcg, "select * from supplier");
                                                                ...
                                                                <button type="submit" class="btn btn-custom" name="updatebarangmasuk" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="barang-form">
                        ...
                        <button type="submit" class="btn btn-custom form-control" name="barangmasuk">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if (isset($_POST['barangmasuk'])) {
    ...
    for ($i = 0; $i < count($barangnya2); $i++) {
        ...
        $stmt_supplier = $conn_hcg->prepare($query_supplier);
        ...
        $stmt_insert = $conn_hcg->prepare($insert_query);
        ...
        if ($stmt_insert->execute()) {
            ...
            $stmt_update_stok = $conn_hcg->prepare($update_stok_query);
...
if (isset($_POST['updatebarangmasuk'])) {
    ...
    $stmt_update_masuk = $conn_hcg->prepare($update_masuk_query);
...
if (isset($_POST['hapusbarangmasuk'])) {
    ...
    if ($result_qty->num_rows > 0) {
        ...
        $stmt_hapus_masuk = $conn_hcg->prepare($hapus_masuk_query);
