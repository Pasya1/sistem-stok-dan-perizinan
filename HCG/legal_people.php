                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL PEOPLE</h1>
                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                $query = mysqli_query($conn_hcg, "SELECT * FROM legal_people");
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px;">
                                    ...
                                    <thead style="background-color: #FF364C; color:white; text-transform: uppercase;">
                                    ...
                                    <tbody>
                                        ...
                                        if (!$result) {
                                            ...
                                            die('Query Error: ' . mysqli_error($conn_hcg));
...
if (isset($_POST['hapuslegal_people'])) {
    ...
    $get_image_query = mysqli_query($conn_hcg, "SELECT dokumentasi FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $file = mysqli_query($conn_hcg, "SELECT * FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $hapuspeople = mysqli_query($conn_hcg, "DELETE FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
