...
$stmt = mysqli_prepare($conn_hcg, "SELECT * FROM legal WHERE id_legal = ?");
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#FF364C; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_sertifikasi;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#FF364C; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Legal</h4>
                            </div>
...
if (isset($_POST['submit_dokumen'])) {
    ...
    $pdfStmt = mysqli_prepare($conn_hcg, "INSERT INTO dokumen_legal (nama_berkas, pdf_path, id_legal) VALUES (?, ?, ?)");
    ...
    $imageStmt = mysqli_prepare($conn_hcg, "INSERT INTO dokumen_legal (nama_gambar, gambar_path, id_legal) VALUES (?, ?, ?)");
...
if (isset($_POST['hapus_gambar'])) {
    ...
    $select_statement = mysqli_prepare($conn_hcg, $select_query);
    ...
    $delete_statement = mysqli_prepare($conn_hcg, $delete_query);
