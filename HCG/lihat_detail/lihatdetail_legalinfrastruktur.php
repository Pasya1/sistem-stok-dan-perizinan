...
if ($_SESSION['role'] !== 'admin_hcg' && $_SESSION['role'] !== 'legal_hcg') {
...
if (isset($_POST['submit_dokumen_infrastruktur'])) {
    ...
    foreach ($imageFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if (!empty($imageFileName2)) {
            ...
            mysqli_query($conn_hcg, $sqlImage);
        }
    }
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_hcg, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    ...
    if (file_exists($lokgambar)) {
        ...
        $hapusgambar = mysqli_query($conn_hcg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    if (file_exists($lokfile)) {
        ...
        $hapusdok = mysqli_query($conn_hcg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
