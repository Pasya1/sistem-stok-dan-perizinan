...
<head>
    ...
    <title>Berkas/ File Permintaan Barang</title>
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BERKAS PERMINTAAN BARANG</h1>
                        ...
                        <div class="">
                            ...
                            <div class="table-responsive shadow-lg px-4" style="border-radius: 10px;">
                                ...
                                <form method="GET" action="arsip_excel_ordering.php" class="form-inline mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas permintaan barang' AND tanggal_upload BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas permintaan barang' AND tanggal_upload ='$mulai'");
                                            } else {
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "select * from berkas_arsip where jenis_berkas = 'berkas permintaan barang'");
                                            }
                                        } else {
                                            $ambilsemuadata_arsip = mysqli_query($conn_hcg, "select * from berkas_arsip where jenis_berkas = 'berkas permintaan barang'");
                                        }
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body mx-3 my-2">
                    ...
                    <!-- Tombol Submit -->
                    <button type="submit" class="btn btn-custom form-control mt-4" name="upload_arsip_ordering">Upload <i class="fas fa-upload"></i></button>
                    </div>
                </div>
            </form>
...
<?php
if(isset($_POST['upload_arsip_ordering'])) {
    ...
    foreach($_FILES['file_arsip']['tmp_name'] as $key => $tmp_name) {
        ...
        if (file_exists($target_file)) {
            echo '<script type="text/javascript">      
                        ...
                        window.location.href = "arsip_excel_ordering.php"; 
            ...
            if($file_type != "xlsx" && $file_type != "xls" && $file_type != "pdf") {
                ...
                if (move_uploaded_file($_FILES["file_arsip"]["tmp_name"][$key], $target_file)) {
                    ...
                    $jenis_berkas = "berkas permintaan barang";
...
if (isset($_POST['hapus_arsip'])) {
    ...
    $query_get_file_path = mysqli_query($conn_hcg, "SELECT file_path FROM berkas_arsip WHERE id_arsip='$id_arsip'");
    $data = mysqli_fetch_assoc($query_get_file_path);
    $file_path = $data['file_path'];

    // Hapus file fisik dari direktori
    if (unlink($file_path)) {
        $hapus = mysqli_query($conn_hcg, "DELETE FROM berkas_arsip WHERE id_arsip='$id_arsip'");
        ...
        if ($hapus) {
            ...
            header('location:arsip_excel_ordering.php');
