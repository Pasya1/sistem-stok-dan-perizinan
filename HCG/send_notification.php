...
if ($result->num_rows > 0) {
    ...
    foreach ($emailPenerima as $email) {
        ...
        //Recipients
        $mail->setFrom('mitraharungasindo0@gmail.com', 'PT Harun Citra Gas');
        ...
        $result = $conn_hcg->query($querymasahabis);
        while ($row = $result->fetch_assoc()) {
            ...
            $mail->AltBody = 'Halo PT. HARUN CITRA GAS,<br><br>' .
