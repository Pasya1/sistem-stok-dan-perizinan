...
<head>
    ...
    <title>Berkas/ File Barang Keluar</title>
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BERKAS BARANG KELUAR</h1>
                        ...
                        <div class="">
                            ...
                            <div class="table-responsive shadow-lg px-4" style="border-radius: 10px;">
                                ...
                                <form method="GET" action="arsip_excel.php" class="form-inline mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload ='$mulai'");
                                            } else {
                                                $ambilsemuadata_arsip = mysqli_query($conn_hcg, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                            }
                                        } else {
                                            $ambilsemuadata_arsip = mysqli_query($conn_hcg, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                        }
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body mx-3 my-2">
                    ...
                    <!-- Tombol Submit -->
                    <button type="submit" class="btn btn-custom form-control mt-4" name="upload_arsip">Upload <i class="fas fa-upload"></i></button>
                    </div>
                </div>
            </form>
    ...
    foreach($_FILES['file_arsip']['tmp_name'] as $key => $tmp_name) {
        ...
        if (file_exists($target_file)) {
            echo '<script type="text/javascript">      
                        ...
                        window.location.href = "arsip_excel.php"; 
            ...
            if($file_type != "xlsx" && $file_type != "xls" && $file_type != "pdf") {
                ...
                if (move_uploaded_file($_FILES["file_arsip"]["tmp_name"][$key], $target_file)) {
                    ...
                    $jenis_berkas = "berkas barang keluar";
...
if (isset($_POST['hapus_arsip'])) {
    ...
    if (unlink($file_path)) {
        ...
        if ($hapus) {
            ...
            header('location:arsip_excel.php');
