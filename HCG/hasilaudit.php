                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">HASIL AUDIT</h1>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-custom" name="edit_hasil_audit" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <button type="submit" class="btn btn-custom form-control" name="submit_hasil_audit">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if (isset($_POST['hapus_hasil_audit'])) {
    ...
    $stmt_select_image = mysqli_prepare($conn_hcg, $query_select_image);
    ...
    $stmt_delete_entry = mysqli_prepare($conn_hcg, $query_delete_entry);
