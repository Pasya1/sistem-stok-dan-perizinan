                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BARANG KELUAR</h1>
                        ...
                        <div class="">
                            ...
                            <div class="table-responsive shadow-lg px-4" style="border-radius: 10px;">
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    ...
                                    <thead style="background-color: #1E5D58; color:white;">
...
if (isset($_POST['barangkeluar'])) {
    ...
    for ($i = 0; $i < count($barangnya); $i++) {
        ...
        $stmt_cek_stok = $conn_hcg->prepare($query_cek_stok);
        ...
        if ($result_stok->num_rows > 0) {
            ...
            if ($stoksekarang >= $qty_barang) {
                ...
                $kodeTransaksi = generateUniqueTransactionCode($conn_hcg);
                ...
                $stmt_add_keluar = $conn_hcg->prepare($query_add_keluar);
                ...
                $stmt_update_stok = $conn_hcg->prepare($query_update_stok);
...
if (isset($_POST['updatebarangkeluar'])) {
    ...
    $lihatstok = $conn_hcg->prepare("SELECT jmlhstok FROM stok WHERE idbarang = ?");
    ...
    $lihatqty = $conn_hcg->prepare("SELECT jumlah FROM keluar WHERE idkeluar = ?");
    ...
    $query_get_barang = $conn_hcg->prepare("SELECT namabarang, dokumentasi FROM stok WHERE idbarang = ?");
    ...
    if ($stoksebelumnya >= $selisih_qty) {
        ...
        $update_stok = $conn_hcg->prepare("UPDATE stok SET jmlhstok = ? WHERE idbarang = ?");
        ...
        $update_keluar = $conn_hcg->prepare("UPDATE keluar SET jumlah = ?, penerima = ?, tanggal_keluar = ?, units = ?, keterangank = ?, namabarang = ?, keperluan = ?, status = ?, user_edit_keluar = ? WHERE idkeluar = ?");
...
if (isset($_POST['hapusbarangkeluar'])) {
    ...
    $status_query = $conn_hcg->prepare("select keperluan from keluar where idkeluar = ?");
    ...
    if ($status_keperluan == 'EXTERNAL'){
        ...
        $delete_query2 = $conn_hcg->prepare("DELETE FROM persetujuan_keluar WHERE id_keluar = ?");
        ...
        if ($delete_result2){
            ...
            $hapus = mysqli_query($conn_hcg, "DELETE FROM keluar WHERE idkeluar='$idk'");
