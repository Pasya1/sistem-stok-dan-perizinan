...
<body class="sb-nav-fixed">
    ...
    <?php
    if ($_SESSION['role'] !== 'management_hcg' && $_SESSION['role'] !== 'keuangan_hcg' && $_SESSION['role'] !== 'owner_hcg') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#FF364C;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">APPROVAL PERMINTAAN BARANG</h1>
                        ...
                        <div class="">
                            <div class="col-md-12 d-flex">
                                <p><a href="#" id="inProgress" style="color: #FF364C; margin-right: 5px;">In Progress</a><p> / </p><a href="#" id="accepted" style="color: #FF364C; margin-right: 5px; margin-left: 5px;">Accepted</a><p> / </p><a href="#" id="rejected" style="color: #FF364C; margin-left: 5px;">Rejected</a></p>
                            </div>
                        <div class="table-responsive shadow-lg px-3 py-5" id="keinprogress" style="border-radius: 10px;">
                               <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    <thead style="background-color: #FF364C; color:white;">
                                        <tr>
                                            <th>Aksi ACC</th>
                                            <th>No Transaksi</th>
                                                ...
                                                if ($role === "owner") {
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                }
                                                    ...
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                }
                                            ...
                                            while ($data = mysqli_fetch_array($ambildatapermintaan)) {
                                                ...
                                                if ($role === "owner" && $total_harga > 10000000) {
                                                    $showOwnerData = true; 
                                                        ...
                                                        $result_count_approvals = mysqli_query($conn_hcg, $query_count_approvals);
                                                        ...
                                                        $result_approved_users = mysqli_query($conn_hcg, $query_approved_users);
                                                        $approved_users = [];
                                                        ...
                                                        foreach ($approved_users as $user_id) {
                                                            ...
                                                            $result_username = mysqli_query($conn_hcg, $query_username);
                                                        ...
                                                        $result_rejected_users = mysqli_query($conn_hcg, $query_rejected_users);
                                                        $rejected_users = [];
                                                        ...
                                                        $result_approved_users_tgl = mysqli_query($conn_hcg, $query_approved_users_tgl);
                                                        $waktu_approve_acc = [];
                                                        while ($row = mysqli_fetch_assoc($result_approved_users_tgl)) {
                                                         ...
                                                         $result_rejected_users_tgl = mysqli_query($conn_hcg, $query_rejected_users_tgl);
                                                                ...
                                                                if ($status_request == 'IN PROGRESS') {
                                                                    ...
                                                                    if ($stmt) {
                                                                        ...
                                                                        if ($row) {
                                                                            ...
                                                                            $stmt_check_user_action = mysqli_prepare($conn_hcg, $query_check_user_action);
                                                                            ...
                                                                            if ($stmt_check_user_action) {
                                                                                ...
                                                                                <?php
                                                                                    ...
                                                                                    echo '<p style="font-size: 10px; color: #FF364C;"><b>Anda sudah melakukan tindakan untuk permintaan ini.</b> Menunggu tindakan dari user lain.</p>';
                                                                                }
                                                                            } else {
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } else {
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_hcg, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['approve']) || isset($_POST['reject'])) {
        ...
        $result_user_id = mysqli_query($conn_hcg, $query_get_user_id);
        ...
        mysqli_query($conn_hcg, $query_add_approval);
        ...
        $result_count_rejects = mysqli_query($conn_hcg, $query_count_rejects);
        ...
        $result_get_status = mysqli_query($conn_hcg, $query_get_status);
        ...
        if ($result_get_status) {
            ...
            if ($current_status == 'IN PROGRESS') {
                ...
                if (isset($query_update_status)) {
                    mysqli_query($conn_hcg, $query_update_status);
                    if(mysqli_affected_rows($conn_hcg) > 0){
                        if ($aksi == 'approve') {
                            echo '<script type="text/javascript">      
                            Swal.fire({
                                position: "center",
