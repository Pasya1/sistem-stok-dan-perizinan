...
<body class="sb-nav-fixed">
    ...
    <?php
    if ($_SESSION['role'] !== 'management_ahg' && $_SESSION['role'] !== 'keuangan_ahg' && $_SESSION['role'] !== 'owner_ahg') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#DD5555;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">APPROVAL PERMINTAAN BARANG</h1>
                                                ...
                                                if ($role === "owner") {
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                }
                                                    ...
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                }
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } else {
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_ahg, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } else {
