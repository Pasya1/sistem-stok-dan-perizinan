                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#DD5555;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL PROCESS</h1>
                    ...
                    if(isset($_POST['sendEmailButton'])){
                        ...
                        $checkStmt = mysqli_prepare($conn_ahg, $checkQuery);
...
if (isset($_POST['hapuslegal'])) {
    ...
    $get_image = mysqli_prepare($conn_ahg, "SELECT dokumentasi FROM legal WHERE id_legal = ?");
    ...
    $delete_query = mysqli_prepare($conn_ahg, "DELETE FROM legal WHERE id_legal = ?");
