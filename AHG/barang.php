            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#DD5555;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">STOK BARANG</h1>
                        ...
                        <div class="">
                            ...
                            $ambildatastok = mysqli_query($conn_ahg, "SELECT * FROM stok WHERE jmlhstok < 1");
                            ...
                            ?>
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    ...
                                    <tbody>
                                        ...
                                        $ambilsemuadata = mysqli_query($conn_ahg, "select * from stok s");
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <select name="namakaryawan" class="form-control" required>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $ambildatakaryawan = mysqli_query($conn_ahg, "select * from karyawan ");
...
if (isset($_POST['addnewbarang'])) {
    ...
    $query_get_nama = $conn_ahg->prepare("SELECT namakaryawan FROM karyawan WHERE idkaryawan = ?");
    ...
    $check_existing_name = $conn_ahg->prepare("SELECT COUNT(*) AS total FROM stok WHERE namabarang = ?");
    ...
    $addtotable = $conn_ahg->prepare("INSERT INTO stok (`idbarang`, `namabarang`, `jmlhstok`, `unit`, `dokumentasi`, `update_stok`, `lokasi_penyimpanan`, `keterangan`, `idkaryawan`, `namakaryawan`, `user_edit_barang`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
if (isset($_POST['updatebarang'])) {
    ...
    $update_query = $conn_ahg->prepare($update_statement);
...
if (isset($_POST['hapusbarang'])) {
    ...
    $delete_query = $conn_ahg->prepare("DELETE FROM stok WHERE idbarang = ?");
