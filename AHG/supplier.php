...
if ($_SESSION['role'] !== 'admin_ahg' && $_SESSION['role'] !== 'logistik_ahg' && $_SESSION['role'] !== 'legal_ahg' && $_SESSION['role'] !== 'supply_ahg') {
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#DD5555;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">DATA SUPPLIER</h1>
                            ...
                            <button type="button" class="btn btn-custom mx-1 mb-3 shadow" data-toggle="modal" data-target="#myModal2" style="float: right;">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-custom" name="updatesupplier" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
- dst."></textarea><br>
                    ...
                    <button type="submit" class="btn btn-custom form-control" name="addnewsupplier">Submit <i class="fas fa-arrow-circle-right"></i></button>
