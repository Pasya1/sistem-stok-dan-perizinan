...
$get = mysqli_prepare($conn_ahg, "SELECT * FROM supplier WHERE idsupplier=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#DD5555; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$supplier;?></h2>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#DD5555; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Supplier</h4>
                            </div>
...
if (isset($_POST['submit_dokumen_supplier'])) {
    ...
    foreach ($pdfFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if ($pdfFileName2 != NULL) {
            ...
            $stmtPDF = mysqli_prepare($conn_ahg, $sqlPDF);
    ...
    foreach ($imageFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if ($imageFileName2 != NULL) {
            ...
            $stmtImage = mysqli_prepare($conn_ahg, $sqlImage);
...
if (isset($_POST['hapus_gambar_supplier'])) {
    ...
    $gambar = mysqli_prepare($conn_ahg, "SELECT * FROM dokumen_supplier WHERE id_berkas_supplier = ?");
    ...
    $hapusgambar = mysqli_prepare($conn_ahg, "DELETE FROM dokumen_supplier WHERE id_berkas_supplier = ?");
...
if (isset($_POST['hapus_berkas_supplier'])) {
    ...
    // Retrieve the file information from the database
    $file = mysqli_prepare($conn_ahg, "SELECT * FROM dokumen_supplier WHERE id_berkas_supplier = ?");
    ...
    $hapusdok = mysqli_prepare($conn_ahg, "DELETE FROM dokumen_supplier WHERE id_berkas_supplier = ?");
