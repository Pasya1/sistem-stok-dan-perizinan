...
$get = mysqli_prepare($conn_ahg, "SELECT * FROM legal_infrastruktur WHERE id_legalinfrastruktur=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#DD5555; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_sertifikasi;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#DD5555; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Legal Infrastruktur</h4>
                            </div>
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_ahg, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    ...
    if (file_exists($lokgambar)) {
        ...
        $hapusgambar = mysqli_query($conn_ahg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    if (file_exists($lokfile)) {
        ...
        $hapusdok = mysqli_query($conn_ahg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
