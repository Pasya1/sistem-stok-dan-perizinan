...
if ($result->num_rows > 0) {
    ...
    foreach ($emailPenerima as $email) {
        ...
        //Recipients
        $mail->setFrom('mitraharungasindo0@gmail.com', 'PT Amanah Harun Gasindo');
        ...
        $result = $conn_ahg->query($querymasahabis);
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="content">
                <p>Halo PT. AMANAH HARUN GASINDO,</p>
            ...
            $mail->AltBody = 'Halo PT. AMANAH HARUN GASINDO,<br><br>' .
