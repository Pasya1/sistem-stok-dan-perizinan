...
if ($result->num_rows > 0) {
    ...
    foreach ($emailPenerima as $email) {
        ...
        //Recipients
        $mail->setFrom('mitraharungasindo0@gmail.com', 'PT Mitra Harun Gasindo');
        ...
        $result = $conn->query($querymasahabis);
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="content">
                <p>Halo PT. MITRA HARUN GASINDO,</p>
            ...
            $mail->AltBody = 'Halo PT. MITRA HARUN GASINDO,<br><br>' .
