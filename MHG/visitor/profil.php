...
if ($_SESSION['role'] !== 'visitor' && $_SESSION['role'] !== 'owner' && $_SESSION['role'] !== 'keuangan' && $_SESSION['role'] !== 'management' && $_SESSION['role'] !== 'ketua_operasional') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="" >
                        <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">PROFILE</h1>
                        </div>
                        <div class="row d-flex justify-content-around mt-5">
                            <div class="col-md-5  shadow-lg px-5 py-5">
                                        ...
                                        $ambiluser = mysqli_query($conn, "select * from login where role='$role'");
                                        while ($row = mysqli_fetch_assoc($ambiluser)){
                                                $username = $row['username'];
                                                $password = $row['password'];

                                        ?>
                                        <h5 style="color:#427D9D;  text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.2);">Informasi Profil</h5><br>
                                        <form method="post">
                                            Username :<br>
                                            ...
                                            <button name="perbarui" class="btn btn-primary form-control">Perbarui</button>
                                        </form>
                            ...
                            <div class="col-md-5 shadow-lg px-5 py-5">
                                    <h5 style="color:#427D9D;  text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.2);">Ganti Password</h5><br>
                                    <form method="post">
                                    <div class="form-group">
                                        ...
                                        <button name="updatepassword" class="btn btn-primary form-control">Perbarui</button>
                                    </form>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary" name="addnewpassword" id="btn">Submit</button>
                </div>
            </form>
...
if (isset($_POST['updatepassword'])) {
    ...
    $ambilpw = mysqli_prepare($conn, "SELECT * FROM login WHERE role = ?");
    ...
    if (password_verify($password_lama, $password_dari_database)) {
        if ($password_baru === $konfirmasi_password_baru) {
            ...
            $update_password_query = mysqli_prepare($conn, "UPDATE login SET password = ? WHERE iduser = ?");
...
if (isset($_POST['addnewpassword'])) {
    ...
    if ($newPassword === $confirmNewPassword) {
        ...
        $update_password_query = mysqli_prepare($conn, "UPDATE login SET password = ?, email = ? WHERE iduser = ?");
