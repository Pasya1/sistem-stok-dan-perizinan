...
<body class="sb-nav-fixed">
    ...
    <?php
    if ($_SESSION['role'] !== 'management' && $_SESSION['role'] !== 'keuangan' && $_SESSION['role'] !== 'owner') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">APPROVAL PERMINTAAN BARANG</h1>
                        ...
                        <div class="">
                            <div class="col-md-12 d-flex">
                                <p><a href="#" id="inProgress" style="color: #427D9D; margin-right: 5px;">In Progress</a><p> / </p><a href="#" id="accepted" style="color: #427D9D; margin-right: 5px; margin-left: 5px;">Accepted</a><p> / </p><a href="#" id="rejected" style="color: #427D9D; margin-left: 5px;">Rejected</a></p>
                            </div>
                                                ...
                                                if ($role === "owner") {
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                }
                                                    ...
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                }
                                            ...
                                            while ($data = mysqli_fetch_array($ambildatapermintaan)) {
                                                ...
                                                if ($role === "owner" && $total_harga > 10000000) {
                                                    $showOwnerData = true; 
                                                        ...
                                                        $result_count_approvals = mysqli_query($conn, $query_count_approvals);
                                                        ...
                                                        $result_approved_users = mysqli_query($conn, $query_approved_users);
                                                        $approved_users = [];
                                                        ...
                                                        $result_rejected_users = mysqli_query($conn, $query_rejected_users);
                                                        $rejected_users = [];
                                                        ...
                                                        $result_approved_users_tgl = mysqli_query($conn, $query_approved_users_tgl);
                                                        $waktu_approve_acc = [];
                                                        while ($row = mysqli_fetch_assoc($result_approved_users_tgl)) {
                                                         ...
                                                         $result_rejected_users_tgl = mysqli_query($conn, $query_rejected_users_tgl);
                                                                ...
                                                                if ($status_request == 'IN PROGRESS') {
                                                                    ...
                                                                    if ($stmt) {
                                                                        ...
                                                                        if ($row) {
                                                                            ...
                                                                            $stmt_check_user_action = mysqli_prepare($conn, $query_check_user_action);
                                                                            ...
                                                                            if ($stmt_check_user_action) {
                                                                                ...
                                                                                <?php
                                                                                    ...
                                                                                    echo '<p style="font-size: 10px; color: #427D9D;"><b>Anda sudah melakukan tindakan untuk permintaan ini.</b> Menunggu tindakan dari user lain.</p>';
                                                                                }
                                                                            } else {
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary" onclick="printModal('statusModal<?= $idp; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } else {
                                            ...
                                            <div class="modal fade" id="statusModal2<?= $idp; ?>" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel2<?= $idp; ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="button" class="btn btn-primary" onclick="printModal2('statusModal2<?= $idp; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } else {
                                             ...
                                             <div class="modal fade" id="statusModal3<?= $idp; ?>" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel3<?= $idp; ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="button" class="btn btn-primary" onclick="printModal3('statusModal3<?= $idp; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['approve']) || isset($_POST['reject'])) {
        ...
        $result_user_id = mysqli_query($conn, $query_get_user_id);
        ...
        mysqli_query($conn, $query_add_approval);
        ...
        $result_count_rejects = mysqli_query($conn, $query_count_rejects);
