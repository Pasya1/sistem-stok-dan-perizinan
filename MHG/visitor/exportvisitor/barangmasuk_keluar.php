                ...
                <?php if(isset($_GET['cari'])){ ?>
                    ...
                    <table class="table table-bordered text-center" id="stok_barang_masuk" width="100%" cellspacing="0" style="margin-left: -50px;">
                        ...
                        <tbody style="text-transform: uppercase;">
                            ...
                            if($mulai != null && $selesai != null && $nama_barang != null ){
                                $ambilsemuadata = mysqli_query($conn, "SELECT * from masuk WHERE tanggal_penerimaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND idbarang = '$nama_barang'");
                            }elseif ($mulai != null && $selesai == null && $nama_barang != null ){
                                $ambilsemuadata = mysqli_query($conn, "SELECT * from masuk WHERE tanggal_penerimaan = '$mulai' AND idbarang = '$nama_barang'");
                            }else{
                    ...
                    <table class="table table-bordered text-center" id="stok_barang_keluar" width="100%" cellspacing="0">
                        ...
                        <tbody style="text-transform: uppercase;">
                            ...
                            if($mulai != null && $selesai != null && $nama_barang != null ){
                                $ambilsemuadata = mysqli_query($conn, "SELECT * from keluar WHERE tanggal_keluar BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND idbarang = '$nama_barang'");
                            }elseif ($mulai != null && $selesai == null && $nama_barang != null ){
                                $ambilsemuadata = mysqli_query($conn, "SELECT * from keluar WHERE tanggal_keluar = '$mulai'AND idbarang = '$nama_barang'");
                            }else{
                                echo 'Tidak Ada Data Dipilih';
                            }
                            $i= 1;
