...
<body class="sb-nav-fixed">
    ...
    <?php
    if ($_SESSION['role'] !== 'management' && $_SESSION['role'] !== 'ketua_operasional') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">APPROVAL BARANG KELUAR</h1>
                        </div>
                        <div class="">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND k.status = 'IN PROGRESS' ORDER BY k.kode_transaksi ASC");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar ='$mulai' AND k.status = 'IN PROGRESS' ORDER BY k.kode_transaksi ASC");
                                            } else {
                                                $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'IN PROGRESS' ORDER BY k.kode_transaksi ASC");
                                            }
                                        } else {
                                            $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'IN PROGRESS' ORDER BY k.kode_transaksi ASC");
                                        }
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary" onclick="printModal2('statusModal<?= $idk; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
                                                        <script>
                                ...
                                <table class="table table-bordered text-center" id="dataTable2" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND k.status = 'ACCEPTED' ORDER BY k.kode_transaksi ASC");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar ='$mulai' AND k.status = 'ACCEPTED' ORDER BY k.kode_transaksi ASC");
                                            } else {
                                                $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'ACCEPTED' ORDER BY k.kode_transaksi ASC");
                                            }
                                        } else {
                                            $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'ACCEPTED' ORDER BY k.kode_transaksi ASC");
                                        }
                                            ...
                                            <div class="modal fade" id="statusModal2<?= $idk; ?>" tabindex="-1" role="dialog" aria-labelledby="statusModal2Label<?= $idk; ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="button" class="btn btn-primary" onclick="printModal3('statusModal2<?= $idk; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
                                                        <script>
                                ...
                                <table class="table table-bordered text-center" id="dataTable3" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND k.status = 'REJECTED' ORDER BY k.kode_transaksi ASC");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM keluar k JOIN stok s ON s.idbarang = k.idbarang WHERE k.tanggal_keluar ='$mulai' AND k.status = 'REJECTED' ORDER BY k.kode_transaksi ASC");
                                            } else {
                                                $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'REJECTED' ORDER BY k.kode_transaksi ASC");
                                            }
                                        } else {
                                            $ambilsemuadata = mysqli_query($conn, "select * from keluar k, stok s where s.idbarang = k.idbarang AND k.status = 'REJECTED' ORDER BY k.kode_transaksi ASC");
                                        }
                                               ...
                                               <div class="modal fade" id="statusModal3<?= $idk; ?>" tabindex="-1" role="dialog" aria-labelledby="statusModal3Label<?= $idk; ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="button" class="btn btn-primary" onclick="printModal3('statusModal3<?= $idk; ?>')"><i class="fas fa-print"></i> Print</button>
                                                        </div>
                                                        <script>
                                                            function printModal3(modalId) {
            ...
            if ($result_get_status) {
                ...
                if ($current_status == 'IN PROGRESS') {
                    if ($aksi == 'approve') { // Menggunakan $aksi untuk menentukan tindakan
                        ...
                        $updatestok = mysqli_query($conn, "UPDATE stok SET jmlhstok='$qtypashapus' WHERE idbarang='$idb'");
