                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL PROCESS</h1>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="editlegal" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="modal-body" style="font-size: 15px;">
                                            ...
                                            <button type="submit" name="sendEmailButton" class="btn btn-primary mb-2" style="float: right;">Kirim <i class="fas fa-arrow-circle-right"></i></button>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary form-control" name="submit_legal">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if (isset($_POST['hapuslegal'])) {
    ...
    $get_image = mysqli_prepare($conn, "SELECT dokumentasi FROM legal WHERE id_legal = ?");
    ...
    $delete_query = mysqli_prepare($conn, "DELETE FROM legal WHERE id_legal = ?");
