        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">KELOLA AKUN USER</h1>
                            
                            <!-- <button type="button" class="btn btn-primary mx-1 shadow mb-3" data-toggle="modal" data-target="#myModal2" style="float: right;">
                                Tambah User Baru +
                            </button> -->
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="hidden" name="iduser" value="<?= $iduser; ?>">
                                                                <button type="submit" class="btn btn-primary" name="updateuser">Edit Data</button>
                                                            </div>
                                                        </form>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary form-control" name="addnewuser">Submit</button>
                </div>
            </form>
...
if (isset($_POST['updateuser'])) {
    ...
    $stmtCheckUsername = $conn->prepare("SELECT COUNT(*) FROM login WHERE username = ?");
    ...
    if ($usernameExists > 0) {
        ...
        $stmtUpdateUser = $conn->prepare("UPDATE login SET role = ?, username = ? WHERE iduser = ?");
