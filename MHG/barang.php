            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">STOK BARANG</h1>

                            <a href="export/barangmasuk_keluar.php" class="btn btn-custom mb-2 shadow" style="float: right;"><i class="fas fa-history"></i> History</a>
                            ...
                            ?>
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px; text-transform: uppercase;">
                                    ...
                                    <tbody>
                                        ...
                                        $ambilsemuadata = mysqli_query($conn, "select * from stok s");
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="updatebarang" style="float: right">Submit <i class="fas fa-arrow-circle-right"></i></button>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary form-control" name="addnewbarang" id="btn">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if (isset($_POST['addnewbarang'])) {
    ...
    $query_get_nama = $conn->prepare("SELECT namakaryawan FROM karyawan WHERE idkaryawan = ?");
    ...
    $check_existing_name = $conn->prepare("SELECT COUNT(*) AS total FROM stok WHERE namabarang = ?");
    ...
    $addtotable = $conn->prepare("INSERT INTO stok (`idbarang`, `namabarang`, `jmlhstok`, `unit`, `dokumentasi`, `update_stok`, `lokasi_penyimpanan`, `keterangan`, `idkaryawan`, `namakaryawan`, `user_edit_barang`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
if (isset($_POST['updatebarang'])) {
    ...
    $update_query = $conn->prepare($update_statement);
...
if (isset($_POST['hapusbarang'])) {
    ...
    $delete_query = $conn->prepare("DELETE FROM stok WHERE idbarang = ?");
