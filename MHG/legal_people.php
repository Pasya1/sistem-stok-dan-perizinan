                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL PEOPLE</h1>
                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM legal_people");
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px;">
                                    ...
                                    <thead style="background-color: #427D9D; color:white; text-transform: uppercase;">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="editlegal_people" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-primary form-control" name="submit_legal_people">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if (isset($_POST['hapuslegal_people'])) {
    ...
    $get_image_query = mysqli_query($conn, "SELECT dokumentasi FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $file = mysqli_query($conn, "SELECT * FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $hapuspeople = mysqli_query($conn, "DELETE FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
