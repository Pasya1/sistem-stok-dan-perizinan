...
$get = mysqli_prepare($conn, "SELECT * FROM karyawan WHERE idkaryawan=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#427D9D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$namakaryawan;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#427D9D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Karyawan</h4>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body" style="font-size: 15px;">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit_dokumen_karyawan">Submit</button>
                </div>
            </form>
