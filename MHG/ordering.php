...
<body class="sb-nav-fixed">
    ...
    if ($_SESSION['role'] !== 'admin' && $_SESSION['role'] !== 'supply' && $_SESSION['role'] !== 'logistik') {
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">PERMINTAAN BARANG</h1>
                            ...
                            <button type="button" class="btn btn-primary shadow" data-toggle="modal" data-target="#myModal" style="margin-bottom: 5px; float: right;">
                                    ...
                                    if(isset($_GET['cari'])){ 
                                        ...
                                        if($mulai != null && $selesai != null && $tgl_apa != null){
                                            if($tgl_apa == 'Tanggal_Buat') {
                                                $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } else {
                                                $ambildatapermintaan = mysqli_query($conn, "select * from permintaan");
                                            }
                                        } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                            if($tgl_apa == 'Tanggal_Buat') {
                                                $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_buat = '$mulai'");
                                            } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                $ambildatapermintaan = mysqli_query($conn, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai'");
                                            } else {
                                                $ambildatapermintaan = mysqli_query($conn, "select * from permintaan");
                                            }
                                        } else {
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="text" name="keterangan" class="form-control" value="<?= $keterangan; ?>"  required><br>
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="updatepermintaan" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary form-control" name="tambahpermintaan">Submit <i class="fas fa-arrow-circle-right"></i></button>
...
if(isset($_POST['tambahpermintaan'])) {
    ...
    foreach($tanggalbuat as $key => $value) {
        ...
        $getSupplierInfo = $conn->prepare("SELECT * FROM supplier WHERE idsupplier = ?");
        ...
        $getbaranginfo = $conn->prepare("SELECT * FROM stok WHERE idbarang = ?");
        ...
        $kodeTransaksi[$key] = generateUniqueTransactionCode($conn);
...
if (isset($_POST['updatepermintaan'])) {
    ...
    $getSupplierInfo = $conn->prepare("SELECT namasupplier FROM supplier WHERE idsupplier = ?");
    ...
    $cekstoksekarang = $conn->prepare("SELECT namabarang FROM stok WHERE idbarang = ?");
    ...
    $updatepermintaan = $conn->prepare("UPDATE permintaan SET tanggal_buat=?, tanggal_permintaan=?, item_barang=?, qty=?, satuan_bentuk=?, harga_satuan=?, ppn=?, diskon=?, total_harga=?, idsupplier=?, nama_supplier_order=?, keterangan=?, user_edit_order=? WHERE id_order=?");
...
if (isset($_POST['hapuspermintaan'])) {
    ...
    $delete_query2 = $conn->prepare("DELETE FROM persetujuan_request WHERE idorder = ?");
    ...
    if ($delete_result2) {
        ...
        $delete_query = $conn->prepare("DELETE FROM permintaan WHERE id_order = ?");
