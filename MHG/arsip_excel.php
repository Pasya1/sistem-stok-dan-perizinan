            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BERKAS BARANG KELUAR</h1>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata_arsip = mysqli_query($conn, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata_arsip = mysqli_query($conn, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload ='$mulai'");
                                            } else {
                                                $ambilsemuadata_arsip = mysqli_query($conn, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                            }
                                        } else {
                                            $ambilsemuadata_arsip = mysqli_query($conn, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                        }
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body mx-3 my-2">
                    ...
                    <!-- Tombol Submit -->
                    <button type="submit" class="btn btn-primary form-control mt-4" name="upload_arsip">Upload <i class="fas fa-upload"></i></button>
                    </div>
                </div>
            </form>
