                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#427D9D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL INFRASTRUKTUR</h1>
                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM legal_infrastruktur");
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="editlegal_infrastruktur" style="float: right;">Submit <i class="fas fa-arrow-circle-right"></i></button>
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary form-control" name="submit_legal_infrastruktur">Submit <i class="fas fa-arrow-circle-right"></i></button>
