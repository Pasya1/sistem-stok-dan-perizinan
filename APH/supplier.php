...
if ($_SESSION['role'] !== 'admin_aph' && $_SESSION['role'] !== 'logistik_aph' && $_SESSION['role'] !== 'legal_aph' && $_SESSION['role'] !== 'supply_aph') {
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#3E578D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">DATA SUPPLIER</h1>
