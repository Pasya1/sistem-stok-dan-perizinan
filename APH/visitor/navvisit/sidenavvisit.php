    <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu" style="overflow-y:auto; min-width: 240px;">
                    <div class="nav">
                        <img src="../assets/logoaph.png" class="mt-2 mx-auto" style="width:90px; display: block;">
                        ...
                        <!-- end -->
                        <?php
                        if ($role === "owner_aph" || $role === "management_aph" || $role === "keuangan_aph" || $role === "ketua_operasional_aph") {
                        ?>
