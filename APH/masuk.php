                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#3E578D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Barang Masuk</h1>
...
if (isset($_POST['barangmasuk'])) {
    ...
    for ($i = 0; $i < count($barangnya2); $i++) {
        ...
        $stmt_supplier = $conn_aph->prepare($query_supplier);
        ...
        $stmt_insert = $conn_aph->prepare($insert_query);
        ...
        if ($stmt_insert->execute()) {
            ...
            $stmt_update_stok = $conn_aph->prepare($update_stok_query);
...
if (isset($_POST['updatebarangmasuk'])) {
    ...
    $stmt_update_masuk = $conn_aph->prepare($update_masuk_query);
...
if (isset($_POST['hapusbarangmasuk'])) {
    ...
    if ($result_qty->num_rows > 0) {
        ...
        $stmt_hapus_masuk = $conn_aph->prepare($hapus_masuk_query);
