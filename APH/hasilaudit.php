                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#3E578D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">HASIL AUDIT</h1>
...
if (isset($_POST['hapus_hasil_audit'])) {
    ...
    $stmt_select_image = mysqli_prepare($conn_aph, $query_select_image);
    ...
    $stmt_delete_entry = mysqli_prepare($conn_aph, $query_delete_entry);
