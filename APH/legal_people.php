                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px;">
                                    ...
                                    <thead style="background-color: #3E578D; color:white; text-transform: uppercase;">
...
if (isset($_POST['hapuslegal_people'])) {
    ...
    $get_image_query = mysqli_query($conn_aph, "SELECT dokumentasi FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $file = mysqli_query($conn_aph, "SELECT * FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $hapuspeople = mysqli_query($conn_aph, "DELETE FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
