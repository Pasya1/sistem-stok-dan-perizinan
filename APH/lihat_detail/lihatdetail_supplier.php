...
if (isset($_POST['submit_dokumen_supplier'])) {
    ...
    foreach ($pdfFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if ($pdfFileName2 != NULL) {
            ...
            $stmtPDF = mysqli_prepare($conn_aph, $sqlPDF);
    ...
    foreach ($imageFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if ($imageFileName2 != NULL) {
            ...
            $stmtImage = mysqli_prepare($conn_aph, $sqlImage);
...
if (isset($_POST['hapus_gambar_supplier'])) {
    ...
    $gambar = mysqli_prepare($conn_aph, "SELECT * FROM dokumen_supplier WHERE id_berkas_supplier = ?");
    ...
    $hapusgambar = mysqli_prepare($conn_aph, "DELETE FROM dokumen_supplier WHERE id_berkas_supplier = ?");
...
if (isset($_POST['hapus_berkas_supplier'])) {
    ...
    // Retrieve the file information from the database
    $file = mysqli_prepare($conn_aph, "SELECT * FROM dokumen_supplier WHERE id_berkas_supplier = ?");
    ...
    $hapusdok = mysqli_prepare($conn_aph, "DELETE FROM dokumen_supplier WHERE id_berkas_supplier = ?");
