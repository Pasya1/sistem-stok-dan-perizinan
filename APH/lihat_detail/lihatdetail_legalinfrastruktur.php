...
if ($_SESSION['role'] !== 'admin_aph' && $_SESSION['role'] !== 'legal_aph') {
...
$get = mysqli_prepare($conn_aph, "SELECT * FROM legal_infrastruktur WHERE id_legalinfrastruktur=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#3E578D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_sertifikasi;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#3E578D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Legal Infrastruktur</h4>
                            </div>
                            ...
                            <div class="row justify-content-center mt-5" style="color:#fff; ">
                                    <div class=" col-md-3 text-center py-3 mx-3 mb-3" style="background-color:#3E578D; border-radius:10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1), 0px 1px 3px rgba(0, 0, 0, 0.4);">
                                    ...
                                    if ($result && mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($nama_file2 == NULL) {
                                                ...
                                                ?>
                                                <button type="button" class="btn btn-danger mb-2 mx-2 mt-4 justify-content-center align-items-center d-flex" data-toggle="modal" data-target="#deleteFileModal<?= $id_berkas_infrastruktur; ?>" style="width: 20px;">
                                            ...
                                            <!-- MODAL HAPUS DOKUMEN -->
                                            <div class="modal fade" id="deleteFileModal<?= $id_berkas_infrastruktur; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteFileModalLabel<?= $id_berkas_infrastruktur; ?>" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteFileModalLabel<?= $id_berkas_infrastruktur; ?>">Konfirmasi Hapus Berkas</h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post">
                                                            <input type="hidden" name="id_berkas_infrastruktur" value="<?= $id_berkas_infrastruktur; ?>">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($nama_gambar2 == NULL) {
                                                ...
                                                echo '<div class="col-md-3 d-flex align-items-center text-center mt-3 mb-3">';
                                                    ...
                                                    ?>
                                                    <button type="button" class="btn btn-danger mb-2 mx-2 mt-4 justify-content-center align-items-center d-flex" data-toggle="modal" data-target="#deleteGambarModal<?= $id_berkas_infrastruktur; ?>" style="width: 20px;">
                                                    <div class="fas fa-trash" style="width: 15px;"></div>
                                                    </button>
                                                    <?php
                                            ...
                                            <!-- MODAL HAPUS GAMBAR -->
                                            <div class="modal fade" id="deleteGambarModal<?= $id_berkas_infrastruktur; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteGambarModalLabel<?= $id_berkas_infrastruktur; ?>" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteGambarModalLabel<?= $id_berkas_infrastruktur; ?>">Konfirmasi Hapus Gambar</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
...
if (isset($_POST['submit_dokumen_infrastruktur'])) {
    $pdfUploadDir2 = "../lihat_detail/dokumen_infrastruktur/";
    $pdfFiles2 = $_FILES['pdf_file2'];
    $idl_infrastruktur = filter_input(INPUT_POST, 'idl_infrastruktur', FILTER_SANITIZE_NUMBER_INT);
    ...
    foreach ($pdfFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if (!empty($pdfFileName2)) {
            ...
            $sqlPDF = "INSERT INTO dokumen_legal_infrastruktur (nama_berkas, pdf_path, id_legalinfrastruktur) VALUES ('$pdfFileName2', '$pdfFilePath2','$idl_infrastruktur')";
            mysqli_query($conn_aph, $sqlPDF);
        }
    }

    $imageUploadDir2 = "../lihat_detail/gambar_legal_infrastruktur/";
    ...
    foreach ($imageFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if (!empty($imageFileName2)) {
            ...
            $sqlImage = "INSERT INTO dokumen_legal_infrastruktur (nama_gambar, gambar_path, id_legalinfrastruktur) VALUES ('$imageFileName2', '$imageFilePath2','$idl_infrastruktur')";
            mysqli_query($conn_aph, $sqlImage);
        }
    }
    ...
    echo '<script type="text/javascript">      
        ...
        setTimeout(function () { 
            window.location.href = "lihatdetail_legalinfrastruktur.php?id_legal_infrastruktur=' . $idl_infrastruktur . '";  
        }, 1500);
        </script>';
}
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    $id_berkas_infrastruktur = filter_input(INPUT_POST, 'id_berkas_infrastruktur', FILTER_SANITIZE_NUMBER_INT);

    $query = mysqli_query($conn_aph, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    $get = mysqli_fetch_array($query);
    $lokgambar = "../lihat_detail/gambar_legal_infrastruktur/" . $get['nama_gambar'];

    if (file_exists($lokgambar)) {
        unlink($lokgambar);

        $hapusgambar = mysqli_query($conn_aph, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
                ...
                setTimeout(function () { 
                    window.location.href = "lihatdetail_legalinfrastruktur.php?id_legal_infrastruktur=' . $get['id_legalinfrastruktur'] . '"; 
                }, 1500);
                </script>';
        } else {
            echo 'Gagal';
            header('Location: lihatdetail_legalinfrastruktur.php?id_legal_infrastruktur=' . $get['id_legalinfrastruktur']);
        }
    } else {
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_aph, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    $get = mysqli_fetch_array($query);
    $lokfile = "../lihat_detail/dokumen_infrastruktur/" . $get['nama_berkas'];

    if (file_exists($lokfile)) {
        unlink($lokfile);

        $hapusdok = mysqli_query($conn_aph, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
