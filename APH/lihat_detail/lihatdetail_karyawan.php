...
$get = mysqli_prepare($conn_aph, "SELECT * FROM karyawan WHERE idkaryawan=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#3E578D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$namakaryawan;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#3E578D; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Karyawan</h4>
                            </div>
...
if (isset($_POST['hapus_gambar_karyawan'])) {
    ...
    if ($id_berkas_karyawan) {
        ...
        $stmtSelect = mysqli_prepare($conn_aph, $querySelect);
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            $stmtDelete = mysqli_prepare($conn_aph, $queryDelete);
