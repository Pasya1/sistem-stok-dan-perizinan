                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#3E578D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">LEGAL INFRASTRUKTUR</h1>
                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                $query = mysqli_query($conn_aph, "SELECT * FROM legal_infrastruktur");
