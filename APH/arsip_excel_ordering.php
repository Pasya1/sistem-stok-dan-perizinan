            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#3E578D;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BERKAS PERMINTAAN BARANG</h1>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata_arsip = mysqli_query($conn_aph, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas permintaan barang' AND tanggal_upload BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata_arsip = mysqli_query($conn_aph, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas permintaan barang' AND tanggal_upload ='$mulai'");
                                            } else {
                                                $ambilsemuadata_arsip = mysqli_query($conn_aph, "select * from berkas_arsip where jenis_berkas = 'berkas permintaan barang'");
                                            }
                                        } else {
                                            $ambilsemuadata_arsip = mysqli_query($conn_aph, "select * from berkas_arsip where jenis_berkas = 'berkas permintaan barang'");
                                        }
...
if (isset($_POST['hapus_arsip'])) {
    ...
    $query_get_file_path = mysqli_query($conn_aph, "SELECT file_path FROM berkas_arsip WHERE id_arsip='$id_arsip'");
    $data = mysqli_fetch_assoc($query_get_file_path);
    $file_path = $data['file_path'];

    // Hapus file fisik dari direktori
    if (unlink($file_path)) {
        $hapus = mysqli_query($conn_aph, "DELETE FROM berkas_arsip WHERE id_arsip='$id_arsip'");
