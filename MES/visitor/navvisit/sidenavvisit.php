    <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu" style="overflow-y:auto; min-width: 240px;">
                    <div class="nav">
                        <img src="../assets/logomes.png" class="mt-2 mx-auto" style="width:90px; display: block;">
                        ...
                        <!-- end -->
                        <?php
                        if ($role === "owner_mes" || $role === "management_mes" || $role === "keuangan_mes" || $role === "ketua_operasional_mes") {
                        ?>
