...
<body class="sb-nav-fixed">
    ...
    <?php
    if ($_SESSION['role'] !== 'management_mes' && $_SESSION['role'] !== 'keuangan_mes' && $_SESSION['role'] !== 'owner_mes') {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class=" mb-4">
                        <div class="">
                            <h1 class="mt-3 text-center mb-4" style="color:#4045AA;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">APPROVAL PERMINTAAN BARANG</h1>
                        ...
                        <div class="">
                            <div class="col-md-12 d-flex">
                                <p><a href="#" id="inProgress" style="color: #4045AA; margin-right: 5px;">In Progress</a><p> / </p><a href="#" id="accepted" style="color: #4045AA; margin-right: 5px; margin-left: 5px;">Accepted</a><p> / </p><a href="#" id="rejected" style="color: #4045AA; margin-left: 5px;">Rejected</a></p>
                            </div>
                                                ...
                                                if ($role === "owner") {
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'IN PROGRESS' and total_harga >= 10000000");
                                                        }
                                                }
                                                    ...
                                                    if($mulai != null && $selesai != null && $tgl_apa != null){
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                    } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                        if($tgl_apa == 'Tanggal_Buat') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'IN PROGRESS'");
                                                        } else {
                                                            $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'IN PROGRESS'");
                                                        }
                                                }
                                                                ...
                                                                if ($status_request == 'IN PROGRESS') {
                                                                    ...
                                                                    if ($stmt) {
                                                                        ...
                                                                        if ($row) {
                                                                            ...
                                                                            $stmt_check_user_action = mysqli_prepare($conn_mes, $query_check_user_action);
                                                                            ...
                                                                            if ($stmt_check_user_action) {
                                                                                ...
                                                                                <?php
                                                                                    ...
                                                                                    echo '<p style="font-size: 10px; color: #4045AA;"><b>Anda sudah melakukan tindakan untuk permintaan ini.</b> Menunggu tindakan dari user lain.</p>';
                                                                                }
                                                                            } else {
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'ACCEPTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'ACCEPTED'");
                                                    }
                                                } else {
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            if(isset($_GET['cari'])){ 
                                                ...
                                                if($mulai != null && $selesai != null && $tgl_apa != null){
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } elseif($mulai != null && $selesai == null && $tgl_apa != null) {
                                                    if($tgl_apa == 'Tanggal_Buat') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_buat = '$mulai' AND status_request = 'REJECTED'");
                                                    } elseif($tgl_apa == 'Tanggal_Permintaan') {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "SELECT * from permintaan WHERE tanggal_permintaan = '$mulai' AND status_request = 'REJECTED'");
                                                    } else {
                                                        $ambildatapermintaan = mysqli_query($conn_mes, "select * from permintaan where status_request = 'REJECTED'");
                                                    }
                                                } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['approve']) || isset($_POST['reject'])) {
        ...
        $result_user_id = mysqli_query($conn_mes, $query_get_user_id);
        ...
        mysqli_query($conn_mes, $query_add_approval);
        ...
        $result_count_rejects = mysqli_query($conn_mes, $query_count_rejects);
        ...
        $result_get_status = mysqli_query($conn_mes, $query_get_status);
        ...
        if ($result_get_status) {
            ...
            if ($current_status == 'IN PROGRESS') {
                ...
                if (isset($query_update_status)) {
                    mysqli_query($conn_mes, $query_update_status);
                    if(mysqli_affected_rows($conn_mes) > 0){
                        if ($aksi == 'approve') {
                            echo '<script type="text/javascript">      
                            Swal.fire({
                                position: "center",
