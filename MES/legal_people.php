                        ...
                        <div class="">
                            ...
                            <?php
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px;">
                                    ...
                                    <thead style="background-color: #4045AA; color:white; text-transform: uppercase;">
...
if (isset($_POST['hapuslegal_people'])) {
    ...
    $get_image_query = mysqli_query($conn_mes, "SELECT dokumentasi FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $file = mysqli_query($conn_mes, "SELECT * FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
    ...
    $hapuspeople = mysqli_query($conn_mes, "DELETE FROM legal_people WHERE id_legalpeople='$id_legalpeople'");
