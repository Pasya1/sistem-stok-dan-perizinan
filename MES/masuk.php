                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#4045AA;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Barang Masuk</h1>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata = mysqli_query($conn_mes, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang WHERE m.tanggal_penerimaan BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata = mysqli_query($conn_mes, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang WHERE m.tanggal_penerimaan = '$mulai'");
                                            } else {
                                                $ambilsemuadata = mysqli_query($conn_mes, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang");
                                            }
                                        } else {
                                            $ambilsemuadata = mysqli_query($conn_mes, "SELECT * FROM masuk m JOIN stok s ON s.idbarang = m.idbarang");
                                        }
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <select name="supplier2" class="form-control" required>
                                                                    ...
                                                                    $ambilsemuadatasupplier = mysqli_query($conn_mes, "select * from supplier");
...
if (isset($_POST['barangmasuk'])) {
    ...
    for ($i = 0; $i < count($barangnya2); $i++) {
        ...
        $stmt_supplier = $conn_mes->prepare($query_supplier);
        ...
        $kodeTransaksi = generateUniqueTransactionCode($conn_mes);
        ...
        $stmt_insert = $conn_mes->prepare($insert_query);
        ...
        if ($stmt_insert->execute()) {
            ...
            $stmt_update_stok = $conn_mes->prepare($update_stok_query);
...
if (isset($_POST['updatebarangmasuk'])) {
    ...
    $stmt_update_masuk = $conn_mes->prepare($update_masuk_query);
...
if (isset($_POST['hapusbarangmasuk'])) {
    ...
    if ($result_qty->num_rows > 0) {
        ...
        $stmt_hapus_masuk = $conn_mes->prepare($hapus_masuk_query);
