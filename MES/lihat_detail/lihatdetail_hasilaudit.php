...
$get = mysqli_prepare($conn_mes, "SELECT * FROM hasil_audit WHERE id_audit=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#4045AA; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_audit;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#4045AA; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Hasil Audit</h4>
                            </div>
                            ...
                            <div class="row" id="serti">
                                <div class="col-md-12 my-4">
                                    <h4 style="color:#4045AA;">FILE HASIL AUDIT :</h4>
                                </div>  
                                <div class="col-md-12">
                                    <?php
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_mes, "SELECT * FROM dokumen_hasil_audit WHERE id_berkas_hasil_audit='$id_berkas_hasil_audit'");
    ...
    if (file_exists($lokgambar)) {
        ...
        $hapusgambar = mysqli_query($conn_mes, "DELETE FROM dokumen_hasil_audit WHERE id_berkas_hasil_audit='$id_berkas_hasil_audit'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    if (file_exists($lokfile)) {
        ...
        $hapusdok = mysqli_query($conn_mes, "DELETE FROM dokumen_hasil_audit WHERE id_berkas_hasil_audit='$id_berkas_hasil_audit'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
