...
$get = mysqli_prepare($conn_mes, "SELECT * FROM legal_infrastruktur WHERE id_legalinfrastruktur=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#4045AA; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_sertifikasi;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#4045AA; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Legal Infrastruktur</h4>
                            </div>
                            ...
                            <div class="row justify-content-center mt-5" style="color:#fff; ">
                                    <div class=" col-md-3 text-center py-3 mx-3 mb-3" style="background-color:#4045AA; border-radius:10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1), 0px 1px 3px rgba(0, 0, 0, 0.4);">
...
if (isset($_POST['submit_dokumen_infrastruktur'])) {
    ...
    foreach ($imageFiles2['tmp_name'] as $key2 => $tmp_name) {
        ...
        if (!empty($imageFileName2)) {
            ...
            mysqli_query($conn_mes, $sqlImage);
        }
    }
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_mes, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    ...
    if (file_exists($lokgambar)) {
        ...
        $hapusgambar = mysqli_query($conn_mes, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    if (file_exists($lokfile)) {
        ...
        $hapusdok = mysqli_query($conn_mes, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
