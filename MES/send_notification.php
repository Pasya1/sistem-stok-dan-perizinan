...
if ($result->num_rows > 0) {
    ...
    foreach ($emailPenerima as $email) {
        ...
        //Recipients
        $mail->setFrom('mitraharungasindo0@gmail.com', 'PT Mitra Energi Selaras');
        ...
        $result = $conn_mes->query($querymasahabis);
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="content">
                <p>Halo PT. MITRA ENERGI SELARAS,</p>
            ...
            $mail->AltBody = 'Halo PT. MITRA ENERGI SELARAS,<br><br>' .
