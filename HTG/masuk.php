...
if (isset($_POST['barangmasuk'])) {
    ...
    for ($i = 0; $i < count($barangnya2); $i++) {
        ...
        $stmt_supplier = $conn_htg->prepare($query_supplier);
        ...
        $stmt_insert = $conn_htg->prepare($insert_query);
        ...
        if ($stmt_insert->execute()) {
            ...
            $stmt_update_stok = $conn_htg->prepare($update_stok_query);
...
if (isset($_POST['updatebarangmasuk'])) {
    ...
    $stmt_update_masuk = $conn_htg->prepare($update_masuk_query);
...
if (isset($_POST['hapusbarangmasuk'])) {
    ...
    if ($result_qty->num_rows > 0) {
        ...
        $stmt_hapus_masuk = $conn_htg->prepare($hapus_masuk_query);
