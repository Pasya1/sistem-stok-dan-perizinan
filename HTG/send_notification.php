...
if ($result->num_rows > 0) {
    ...
    foreach ($emailPenerima as $email) {
        ...
        //Recipients
        $mail->setFrom('mitraharungasindo0@gmail.com', 'PT Harun Tabung Gasindo');
        ...
        $result = $conn_htg->query($querymasahabis);
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="content">
                <p>Halo PT. HARUN TABUNG GASINDO,</p>
            ...
            $mail->AltBody = 'Halo PT. HARUN TABUNG GASINDO,<br><br>' .
