            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <h1 class="mt-3 text-center mb-4" style="color:#1E7458;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">BERKAS BARANG KELUAR</h1>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_GET['cari'])){ 
                                            ...
                                            if($mulai != null && $selesai != null){
                                                $ambilsemuadata_arsip = mysqli_query($conn_htg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                            } elseif($mulai != null && $selesai == null) {
                                                $ambilsemuadata_arsip = mysqli_query($conn_htg, "SELECT * FROM berkas_arsip WHERE jenis_berkas = 'berkas barang keluar' AND tanggal_upload ='$mulai'");
                                            } else {
                                                $ambilsemuadata_arsip = mysqli_query($conn_htg, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                            }
                                        } else {
                                            $ambilsemuadata_arsip = mysqli_query($conn_htg, "select * from berkas_arsip where jenis_berkas = 'berkas barang keluar'");
                                        }
