                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4">
                        ...
                        <div class="">
                            ...
                            <h1 class="mt-3 text-center mb-4" style="color:#1E7458;  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">KELOLA AKUN USER</h1>
                            ...
                            <div class="table-responsive shadow-lg px-3 py-5">
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="" cellspacing="0" style="font-size:11px;">
                                    ...
                                    <tbody>
                                        ...
                                        $ambilsemuadata = mysqli_query($conn_htg, "select * from login");
...
if (isset($_POST['updateuser'])) {
    ...
    $stmtCheckUsername = $conn_htg->prepare("SELECT COUNT(*) FROM login WHERE username = ?");
    ...
    if ($usernameExists > 0) {
        ...
        $stmtUpdateUser = $conn_htg->prepare("UPDATE login SET role = ?, username = ? WHERE iduser = ?");
