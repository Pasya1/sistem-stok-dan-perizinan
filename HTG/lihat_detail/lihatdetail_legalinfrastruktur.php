...
$get = mysqli_prepare($conn_htg, "SELECT * FROM legal_infrastruktur WHERE id_legalinfrastruktur=?");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-3 text-center mb-4" style="color:#1E7458; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);"><?=$jenis_sertifikasi;?></h1>
                        <div class="card-body">
                            <div class="row mt-5">
                                <h4 style="color:#1E7458; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Detail Legal Infrastruktur</h4>
                            </div>
                            ...
                            <div class="row justify-content-center mt-5" style="color:#fff; ">
                                    <div class=" col-md-3 text-center py-3 mx-3 mb-3" style="background-color:#1E7458; border-radius:10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1), 0px 1px 3px rgba(0, 0, 0, 0.4);">
                            ...
                            <div class="row" id="serti">
                                <div class="col-md-12 my-4">
                                    <h4 style="color:#1E7458;">FILE SERTIFIKAT :</h4>
                                </div>  
                                <div class="col-md-12">
                                    <?php
...
if (isset($_POST['hapus_gambar_infrastruktur'])) {
    ...
    $query = mysqli_query($conn_htg, "SELECT * FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
    ...
    if (file_exists($lokgambar)) {
        ...
        $hapusgambar = mysqli_query($conn_htg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusgambar) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
...
if (isset($_POST['hapus_berkas_infrastruktur'])) {
    ...
    if (file_exists($lokfile)) {
        ...
        $hapusdok = mysqli_query($conn_htg, "DELETE FROM dokumen_legal_infrastruktur WHERE id_berkas_infrastruktur='$id_berkas_infrastruktur'");
        if ($hapusdok) {
            echo '<script type="text/javascript">      
                Swal.fire({
                    position: "center",
