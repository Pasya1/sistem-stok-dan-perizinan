...
<head>
  ...
  <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
    ...
    .area{
        background: #8E0100;  
        background: -webkit-linear-gradient(to left, #8f94fb, #8E0100);  
        width: 100%;
        height:100vh;
        z-index: 250;
...
<body>
    ...
    <div class="context">
            <div data-aos="fade-up" data-aos-duration="1000">
                <h1>PT. AMANAH HARUN GASINDO</h1>
            </div>
            <div class="col-md-12 text-center justify-content-center px-4" style="font-size:14px; color:white;">
            <div data-aos="zoom-in" data-aos-duration="3000">
              <p class="mt-4" style="line-height: 1;">Bergerak dibidang agen LPG 3kg bersubsidi   </p>
              <p class="mb-5" style="line-height: 1;">di daerah Megamendung, Kabupaten Bogor.</p>
            </div> 
            ...
            <div class="col-md-4">
                <div data-aos="fade-right" data-aos-duration="3000">
                    <div class="kotak d-flex justify-content-center text-center align-items-center px-4 pt-2">
                        <img src="../img/logo/logo4.png" style="width: 90px; height: 70px;">
    ...
    <div class="section min-vh-100 mt-5 pt-2 mx-5 justify-content-center align-items-center" id="about">
        ...
        <div data-aos="fade-up" data-aos-duration="3000">
            <div class="row justify-content-center" style="text-align:justify;">
                <div class="col-md-5">
                    <p class="isiabout animated-flyInup ">PT. Amanah Harun Gasindo bergerak dibidang Agen LPG 3 kg bersubsidi. Fungsi Agen disini membantu pemerintah menyalurkan pendistribusian Gas LPG 3kg untuk masyarakat di wilayah yang sudah ditentukan oleh Pertamina. </p> 
                </div>
                <div class="col-md-5">
                    <p class="isiabout animated-flyIn">Gas LPG 3KG tersebut diambil dari SPBE yang diatur oleh Pertamina untuk DO (Delivery Order)nya, pendistribusian Gas LPG 3 kg ini dilakukan melalui pangkalan-pangkalan yang sudah ada kontraknya dengan Agen PT. Amanah Putera Harun.</p> 
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- GALERY -->
<div class="section min-vh-50" id="gallery"  style="background: #8E0100;">
    <div class="container" style="background: #8E0100;">
        <div class="carousel-container pt-3 position-relative row">
            <div data-aos="zoom-in" data-aos-duration="3000">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-slide-number="0">
                        <img src="../img/ahg/gambar1.jpeg" class="d-block w-100" alt="..." data-remote="../img/ahg/gambar1.jpeg" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                        </div>
                        <div class="carousel-item" data-slide-number="1">
                        <img src="../img/ahg/gambar2.jpeg" class="d-block w-100" alt="..." data-remote="../img/ahg/gambar2.jpeg" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                        </div>
                        <div class="carousel-item" data-slide-number="2">
                        <img src="../img/ahg/gambar3.jpeg" class="d-block w-100" alt="..." data-remote="../img/ahg/gambar3.jpeg" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                        </div>
                        <div class="carousel-item" data-slide-number="3">
                        <img src="../img/ahg/gambar4.jpeg" class="d-block w-100" alt="..." data-remote="../img/ahg/gambar4.jpeg" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                        </div>
                        <div class="carousel-item" data-slide-number="4">
                        <img src="../img/ahg/gambar5.jpeg" class="d-block w-100" alt="..." data-remote="../img/ahg/gambar5.jpeg" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div class="carousel-inner">
                        ...
                        <div class="row mx-0">
                            ...
                            <img src="../img/ahg/gambar1.jpeg" class="img-fluid" alt="...">
                            </div>
                            <div id="carousel-selector-1" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
                            <img src="../img/ahg/gambar2.jpeg" class="img-fluid" alt="...">
                            </div>
                            <div id="carousel-selector-2" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
                            <img src="../img/ahg/gambar3.jpeg" class="img-fluid" alt="...">
                            </div>
                            <div id="carousel-selector-3" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="3">
                            <img src="../img/ahg/gambar4.jpeg" class="img-fluid" alt="...">
                            </div>
                            <div id="carousel-selector-4" class="thumb col-4 col-sm-2 px-1 py-2" data-target="#myCarousel" data-slide-to="4">
                            <img src="../img/ahg/gambar5.jpeg" class="img-fluid" alt="...">
                            </div>
                        </div>
                    </div>
                </div>
